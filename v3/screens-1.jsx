// VÉDICO — Hoje and Mapa screens
// Voice in PT-BR, soft Marcio CTAs.
  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, overflowY: 'auto', overflowX: 'hidden', paddingBottom: 100 }}>
        ...
        <div style={{ padding: '20px 22px 0' }}>
          <article style={{
            ...
            <div style={{
              ...
              <div style={{ position: 'absolute', left: 158, top: 110 }}>
                <StarSmall size={11} color={V2.terracotta} stroke={1.2} />
              </div>
              <div style={{ position: 'absolute', right: 100, top: 30 }}>
                <StarSmall size={9} color={V2.walnut} stroke={1} />
              </div>
              <div style={{ position: 'absolute', right: 148, bottom: 36 }}>
                <StarSmall size={13} color={V2.gold} stroke={1.2} />
              </div>
            ...
            {/* Soft Márcio CTA — only because the period is heavy (Saturn) */}
            <div style={{
        ...
        {/* 2-up grid — Lua + Próxima Consulta */}
        <div style={{ padding: '20px 22px 0', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
          ...
          <article onClick={() => go('conta')} style={{
            background: V2.paper, borderRadius: 6, padding: 14,
            boxShadow: '0 1px 0 rgba(42,31,26,0.04), 0 14px 22px -16px rgba(42,31,26,0.18)',
            position: 'relative', minHeight: 170, overflow: 'hidden',
...
// ─── MAPA ─────────────────────────────────────────────────────────
// South-Indian chart (16 boxes around the perimeter — but classical layout
// is a 4x4 grid with an empty 2x2 center). We render the 12 rashi houses.

const RASHI = [
  // South Indian fixed layout — Meena top-left, clockwise
  // We'll lay out as a 4×4 grid; positions: row, col
...
const PLANETS_IN_HOUSE = {
  // Beatriz's chart (sample) — short labels
  'Mesha':   ['Su', 'Me'],
  'Vrishabha': [],
  'Mithuna': ['Ve'],
  'Karka':   ['Ma'],
      ...
      <div style={{ flex: 1, overflowY: 'auto', overflowX: 'hidden', paddingBottom: 100 }}>
        ...
        <div style={{ padding: '18px 22px 0', display: 'flex', flexDirection: 'column', gap: 10 }}>
          {[
            ...
            { p: 'Marte',   sign: 'Câncer',  house: '7ª casa', note: 'sobre vínculos',          sw: V2.rose },
          ].map((t) => (
            <div key={t.p} style={{
              background: V2.paper, borderRadius: 6, padding: '14px 18px',
              border: `0.6px solid ${V2.walnutSoft}33`,
        ...
        {/* Soft Marcio CTA at end of mapa */}
        <div style={{ padding: '24px 22px 0' }}>
          <div onClick={() => go('conta')} style={{
